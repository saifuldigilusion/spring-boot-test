...
<body>
	...
	<button id="new" onclick="window.location.replace('/book/add');">New</button>
	</div>
</body>
    ...
    $('#books').DataTable( {
        ...
        "columns": [
        	...
        	{"data": "id", "render": function ( data, type, row, meta ) {
        		return "<button onclick=\"window.location.replace('/book/detail/" + data + "');\">Edit</button> <button onclick=deleteItem(" + data + ");>Delete</button>";
        		}
        	}
        	],
        "paging":   false,
